...
namespace Reallusion.Import
{
    public static class MeshUtil
    {
        ...
        [MenuItem("CC-iC/Mesh Tools/Reverse Triangle Order", priority = 100)]
        ...
        [MenuItem("CC-iC/Mesh Tools/Prune Blend Shapes", priority = 101)]
        ...
        [MenuItem("CC-iC/Mesh Tools/Auto Smooth Mesh", priority = 102)]
        ...
        [MenuItem("CC-iC/Tools/Add HDRP Diffusion Profiles", priority = 180)]
        ...
        /*
        [MenuItem("CC-iC/Tools/Setup Dual Material Hair", priority = 700)]
